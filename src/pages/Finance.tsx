...
const Finance: React.FC = () => {
  ...
  const handleExport = async (type: 'EXCEL' | 'PDF' | 'IMAGE' | 'PRINT') => {
    ...
    if (type === 'EXCEL') {
      // Usando truque do HTML Table para gerar um Excel Colorido e Formatado conforme mockup
      let htmlContent = `
  ...
  if (selectedCompany) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        {/* Relatório de Impressão Detalhado (Visível apenas no print) */}
        ...
        {/* Interface de Tela (Oculta no print) */}
        ...
        {/* Feedback de Loading Global "Animated" */}
        {exporting && (
